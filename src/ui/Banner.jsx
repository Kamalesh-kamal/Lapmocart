...
function Banner() {
    return (
        <div className="flex justify-center items-center">
            <img src="src/images/banner1.png" alt="" className="h-[200px] w-[340px] rounded-xl md:w-[600px] md:h-[360px] lg:w-[800px] xl:w-[1000px] xl:h-[660px]" />
            <div>
        <Link to={"/products"}>
          ...
          md:text-lg md:rounded-full xl:translate-y-[200px] xl:-translate-x-[200px]
