...
function ProductDetails() {
  ...
  const { id, productsFilterBy, productsSortBy } = useParams();
  ...
  return (
    <div className="w-[100%] flex justify-between">
      <div>
        <button
          className="bg-blue-500 text-[#fff] px-5 py-1 rounded-2xl flex absolute z-10 right-0  md:hidden"
          onClick={() => setVisible((prev) => !prev)}
        >
          {visible ? "X" : "filter&Sort"}
        </button>
      </div>
              ...
              return (
                ...
                >
                  ...
                  <div className=" flex flex-col w-[80%] h-[100%] text-justify gap-1">
                    ...
                    {itm.type === "mobile" ? (
                      <h2>
                        <span className="font-semibold italic">{itm.name}</span>{" "}
                        provided by{" "}
                      ...
                      <h2>
                        ...
                        storage, providing ample space and fast access to files.
                      </h2>
                    )}
                    <div className="">
                      {existedItm ? (
